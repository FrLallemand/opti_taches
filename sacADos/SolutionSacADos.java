...
public class SolutionSacADos extends SolutionPartielle {
	...
	public SolutionSacADos perturb() {
		Random rand = new Random();
		SolutionSacADos copie = new SolutionSacADos(this);
		int rndObj = rand.nextInt(copie.objetsPresents.length);
		copie.objetsPresents[rndObj] = !copie.objetsPresents[rndObj];
		profondeurTraitee = rndObj;
		return copie;
	}
